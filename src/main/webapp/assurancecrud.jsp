     ...
     <section id="main-content">         
          <div class="row">
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">AssuranceID*</label>
                   <div class="col-sm-2">
                    	<c:if test="${assurance != null }">
                        <input type="hidden" class="form-control" name="assuranceID"  value="<c:out value='${assurance.assuranceID}' />" />
                   		</c:if>
                    </div>
            </div>
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Nom assureur*</label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="nomAssureur"   value="<c:out value='${assurance.nomAssureur}' />" />
                    </div>
            </div>
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Province*</label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control"  name="province"   value="<c:out value='${assurance.province}' />" />
                    </div>
            </div>
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Ville*</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="ville"   required  value="<c:out value='${assurance.ville}' />" />
                    </div>
            </div>
          
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Assurance couvert*</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control"  name="assuranceCouvert"    required  value="<c:out value='${assurance.assuranceCouvert}' />" />
                    </div>
            </div>
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Date debut*</label>
                    <div class="col-sm-4">
                        <input type="date" class="form-control"   required  name="dateDebut" value="<c:out value='${assurance.dateDebut}' />" />
                    </div>
            </div>
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Date fin</label>
                    <div class="col-sm-4">
                        <input type="date" class="form-control"    name="dateFin" value="<c:out value='${assurance.dateFin}' />" />
                    </div>
            </div> 
            ...
            <div class="m-l-150">
                        ...
                        <button type="submit" name="Ajouter" class="btn btn-primary btn-flat btn-addon m-b-10 m-l-5"><i class="ti-plus"></i>Enregistrer</button>
