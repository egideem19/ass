                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/list">Client</a></li>
            ...
            <div class="col-lg-12">
              <div class="card">
                 <div class="inbox-head">
                            <h3 class="input-text">Clients</h3>
                            <form action="#" class="pull-right position">
                              <div class="input-append inner-append">
                                <input type="text" class="sr-input" placeholder="tapez le clientID">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-3">
                      <a href="<%=request.getContextPath()%>/new"   class="btn btn-lg btn-primary btn-block waves-effect waves-light">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                	...
                                                	<td><c:out value="${client.genre}"/></td>
                                                		<td><c:out value="${client.nomAssureur}"/></td>
                                                
                                                	<td><a href="edit?clientID=<c:out value='${client.clientID}'/>">Modifier</a>
                                                		&nbsp; &nbsp; &nbsp; &nbsp; 
                                                		<a href="delete?clientID=<c:out value='${client.clientID}'/>">Supprimer</a>
                                                	 </td>
