...
<!-- /#fin header -->
 ...
 <!-- Inserer username venant du DB    --> <h1>Hello <%=session.getAttribute("prenom") %> <span>Bienvenue sur OpenAssu</span></h1>
                    ...
                    <!-- /# column -->
                    <div class="col-lg-4 p-l-0 tit le-margin-left">
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.jsp">Tableau de bord</a></li>
                                    <li class="breadcrumb-item active">Mutuelle de santé</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
              <div class="card">
                 <div class="inbox-head">
                            <h3 class="input-text">Mutuelle de santé</h3>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-3">
                      <a href="<%=request.getContextPath()%>/newM"   class="btn btn-lg btn-primary btn-block waves-effect waves-light">
                        <i class="fa fa-plus"></i> Nouveau mutuelle
                      </a>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover ">
                                            ...
                                            <tbody>
                                            	<c:forEach var="mutuelle" items="${listMutuelle}" >
                                                <tr>
                                                    <td><c:out value="${mutuelle.mutuelleID}"/></td>
                                                	<td><c:out value="${mutuelle.nomMutuelle}"/></td>
                                                
                                                	<td><c:out value="${mutuelle.mutuelleCouvert}"/></td>
                                                	<td><c:out value="${mutuelle.dateEntre}"/></td>
                                                	
                                                	<td><a href="editM?mutuelleID=<c:out value='${mutuelle.mutuelleID}'/>">Modifier</a>
                                                		&nbsp; &nbsp; &nbsp; &nbsp; 
                                                		<a href="deleteM?mutuelleID=<c:out value='${mutuelle.mutuelleID}'/>">Supprimer</a>
                                                	 </td>
                                                </tr>
                                                  </c:forEach>
