...
<title>Utilisateur | OpenAssu</title>
            ...
            <div class="col-lg-12">
              <div class="card">
                 <div class="inbox-head">
                            <h3 class="input-text">Utilisateurs</h3>
                            <form action="#" class="pull-right position">
                              <div class="input-append inner-append">
                                <input type="text" class="sr-input" placeholder="tapez le UserID">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-3">
                      <a href="<%=request.getContextPath()%>/newU"   class="btn btn-lg btn-primary btn-block waves-effect waves-light">
                                        ...
                                        <table class="table table-hover ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                	...
                                                	<td><a href="editU?idUser=<c:out value='${user.idUser}'/>">Modifier</a>
                                                		&nbsp; &nbsp; &nbsp; &nbsp; 
                                                		<a href="deleteU?idUser=<c:out value='${user.idUser}'/>">Supprimer</a>
                                                	 </td>
                                                </tr>
                                                 </c:forEach>
